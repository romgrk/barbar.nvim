...
vim.api.nvim_create_user_command(
  'BufferClose',
  function(tbl) require'bbye'.delete('bdelete', tbl.bang, tbl.args, tbl.mods) end,
...
vim.api.nvim_create_user_command(
  'BufferWipeout',
  function(tbl) require'bbye'.delete('bwipeout', tbl.bang, tbl.args, tbl.mods) end,
...
function BufferlineMainClickHandler(minwid, _, btn, _)
  ...
  if btn == 'm' then
    require'bbye'.delete('bdelete', false, minwid)
  else
